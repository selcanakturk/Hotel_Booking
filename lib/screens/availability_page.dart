...
//             DropdownButton<int>(
//               value: selectedPersonCount == 0 ? null : selectedPersonCount,
...
//         ),
//         const Divider(),
//         ...rooms.where((room) => selectedPersonCount == 0 || room['capacity'] >= selectedPersonCount).map((room) {
//           final visibleAvail =
